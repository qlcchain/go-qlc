...
import (
	common "github.com/qlcchain/go-qlc/common"
	ed25519 "github.com/qlcchain/go-qlc/crypto/ed25519"

	event "github.com/qlcchain/go-qlc/common/event"

	ledger "github.com/qlcchain/go-qlc/ledger"

	mock "github.com/stretchr/testify/mock"

	storage "github.com/qlcchain/go-qlc/common/storage"

	types "github.com/qlcchain/go-qlc/common/types"
)
...
func (_m *Store) AddFrontier(frontier *types.Frontier, c *ledger.Cache) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*types.Frontier, *ledger.Cache) error); ok {
		r0 = rf(frontier, c)
	} else {
		r0 = ret.Error(0)
	}
...
// AddOrUpdateContractValue provides a mock function with given fields: key, value, c
func (_m *Store) AddOrUpdateContractValue(key *types.ContractKey, value *types.ContractValue, c ...storage.Cache) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*types.ContractKey, *types.ContractValue, ...storage.Cache) error); ok {
		r0 = rf(key, value, c...)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) AddPending(key *types.PendingKey, value *types.PendingInfo, c *ledger.Cache) error {
	ret := _m.Called(key, value, c)

	var r0 error
	if rf, ok := ret.Get(0).(func(*types.PendingKey, *types.PendingInfo, *ledger.Cache) error); ok {
		r0 = rf(key, value, c)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) AddRepresentation(address types.Address, diff *types.Benefit, c *ledger.Cache) error {
	ret := _m.Called(address, diff, c)

	var r0 error
	if rf, ok := ret.Get(0).(func(types.Address, *types.Benefit, *ledger.Cache) error); ok {
...
// AddTokenMetaConfirmed provides a mock function with given fields: address, meta, cache
func (_m *Store) AddTokenMetaConfirmed(address types.Address, meta *types.TokenMeta, cache *ledger.Cache) error {
	ret := _m.Called(address, meta, cache)

	var r0 error
	if rf, ok := ret.Get(0).(func(types.Address, *types.TokenMeta, *ledger.Cache) error); ok {
		r0 = rf(address, meta, cache)
	} else {
		r0 = ret.Error(0)
	}
...
// CountContractValues provides a mock function with given fields:
func (_m *Store) CountContractValues() (uint64, error) {
	ret := _m.Called()
...
// DeleteContractValue provides a mock function with given fields: key, c
func (_m *Store) DeleteContractValue(key *types.ContractKey, c ...storage.Cache) error {
	_va := make([]interface{}, len(c))
	for _i := range c {
		_va[_i] = c[_i]
	}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*types.ContractKey, ...storage.Cache) error); ok {
		r0 = rf(key, c...)
	} else {
		r0 = ret.Error(0)
	}
...
// DeleteContractValueByBlock provides a mock function with given fields: block, c
func (_m *Store) DeleteContractValueByBlock(block *types.StateBlock, c ...storage.Cache) error {
	_va := make([]interface{}, len(c))
	for _i := range c {
		_va[_i] = c[_i]
	}
...
func (_m *Store) DeleteFrontier(key types.Hash, c *ledger.Cache) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(types.Hash, *ledger.Cache) error); ok {
		r0 = rf(key, c)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) DeletePending(key *types.PendingKey, c *ledger.Cache) error {
	ret := _m.Called(key, c)

	var r0 error
	if rf, ok := ret.Get(0).(func(*types.PendingKey, *ledger.Cache) error); ok {
		r0 = rf(key, c)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Store) DeleteTokenMetaConfirmed(address types.Address, tokenType types.Hash, c *ledger.Cache) error {
	ret := _m.Called(address, tokenType, c)

	var r0 error
	if rf, ok := ret.Get(0).(func(types.Address, types.Hash, *ledger.Cache) error); ok {
...
// GetContractValue provides a mock function with given fields: key, c
func (_m *Store) GetContractValue(key *types.ContractKey, c ...storage.Cache) (*types.ContractValue, error) {
	_va := make([]interface{}, len(c))
	for _i := range c {
		_va[_i] = c[_i]
	}
	...
	var r0 *types.ContractValue
	if rf, ok := ret.Get(0).(func(*types.ContractKey, ...storage.Cache) *types.ContractValue); ok {
		r0 = rf(key, c...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.ContractValue)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(*types.ContractKey, ...storage.Cache) error); ok {
		r1 = rf(key, c...)
	} else {
		r1 = ret.Error(1)
	}
...
// IteratorContractStorage provides a mock function with given fields: prefix, callback
func (_m *Store) IteratorContractStorage(prefix []byte, callback func(*types.ContractKey, *types.ContractValue) error) error {
	ret := _m.Called(prefix, callback)

	var r0 error
	if rf, ok := ret.Get(0).(func([]byte, func(*types.ContractKey, *types.ContractValue) error) error); ok {
...
func (_m *Store) SubRepresentation(address types.Address, diff *types.Benefit, c *ledger.Cache) error {
	ret := _m.Called(address, diff, c)
