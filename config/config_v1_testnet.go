...
func DefaultConfigV1(dir string) (*ConfigV1, error) {
	...
	cfg = ConfigV1{
		...
		P2P: &P2PConfigV1{
			BootNodes: []string{
				"/ip4/47.103.40.20/tcp/19734/p2p/QmdFSukPUMF3t1JxjvTo14SEEb5JV9JBT6PukGRo6A2g4f",
				"/ip4/47.112.112.138/tcp/19734/p2p/QmW9ocg4fRjckCMQvRNYGyKxQd6GiutAY4HBRxMrGrZRfc",
			},
