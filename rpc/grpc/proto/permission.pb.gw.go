...
func request_PermissionAPI_GetAdminHandoverBlock_0(ctx context.Context, marshaler runtime.Marshaler, client PermissionAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PermissionAPI_GetAdminHandoverBlock_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_PermissionAPI_GetAdminHandoverBlock_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AdminUpdateParam
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetAdminHandoverBlock(ctx, &protoReq)
	return msg, metadata, err
...
func local_request_PermissionAPI_GetAdmin_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq empty.Empty
	var metadata runtime.ServerMetadata
...
func request_PermissionAPI_GetNodeUpdateBlock_0(ctx context.Context, marshaler runtime.Marshaler, client PermissionAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PermissionAPI_GetNodeUpdateBlock_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_PermissionAPI_GetNodeUpdateBlock_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq NodeParam
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetNodeUpdateBlock(ctx, &protoReq)
	return msg, metadata, err
...
func request_PermissionAPI_GetNode_0(ctx context.Context, marshaler runtime.Marshaler, client PermissionAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PermissionAPI_GetNode_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_PermissionAPI_GetNode_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq String
	var metadata runtime.ServerMetadata
...
func local_request_PermissionAPI_GetNodesCount_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq empty.Empty
	var metadata runtime.ServerMetadata

	msg, err := server.GetNodesCount(ctx, &protoReq)
	return msg, metadata, err
...
func request_PermissionAPI_GetNodes_0(ctx context.Context, marshaler runtime.Marshaler, client PermissionAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PermissionAPI_GetNodes_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_PermissionAPI_GetNodes_0(ctx context.Context, marshaler runtime.Marshaler, server PermissionAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Offset
	var metadata runtime.ServerMetadata
...
func RegisterPermissionAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PermissionAPIServer) error {
	...
	mux.Handle("GET", pattern_PermissionAPI_GetAdminHandoverBlock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetAdminHandoverBlock_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_PermissionAPI_GetAdmin_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetAdmin_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_PermissionAPI_GetNodeUpdateBlock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetNodeUpdateBlock_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_PermissionAPI_GetNode_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetNode_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_PermissionAPI_GetNodesCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetNodesCount_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_PermissionAPI_GetNodes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PermissionAPI_GetNodes_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_PermissionAPI_GetAdminHandoverBlock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getAdminHandoverBlock"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PermissionAPI_GetAdmin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getAdmin"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PermissionAPI_GetNodeUpdateBlock_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getNodeUpdateBlock"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PermissionAPI_GetNode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getNode"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PermissionAPI_GetNodesCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getNodesCount"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_PermissionAPI_GetNodes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"permission", "getNodes"}, "", runtime.AssumeColonVerbOpt(true)))
)
