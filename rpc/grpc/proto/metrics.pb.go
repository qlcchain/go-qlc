...
type InfoStats struct {
	...
	Infos []*InfoStat `protobuf:"bytes,1,rep,name=infos,proto3" json:"infos,omitempty"`
}
...
func (x *InfoStats) GetInfos() []*InfoStat {
	if x != nil {
		return x.Infos
	}
	return nil
...
var file_metrics_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0xd2, 0x02, 0x0a, 0x08, 0x49, 0x6e, 0x66, 0x6f, 0x53, 0x74,
...
var file_metrics_proto_depIdxs = []int32{
	1, // 0: proto.InfoStats.infos:type_name -> proto.InfoStat
