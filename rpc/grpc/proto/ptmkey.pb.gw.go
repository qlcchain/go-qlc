...
func RegisterPtmKeyAPIHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPtmKeyAPIHandler(ctx, mux, conn)
}

// RegisterPtmKeyAPIHandler registers the http handlers for service PtmKeyAPI to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPtmKeyAPIHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPtmKeyAPIHandlerClient(ctx, mux, NewPtmKeyAPIClient(conn))
}

// RegisterPtmKeyAPIHandlerClient registers the http handlers for service PtmKeyAPI
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "PtmKeyAPIClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "PtmKeyAPIClient"
...
func RegisterPtmKeyAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PtmKeyAPIClient) error {
	...
	mux.Handle("POST", pattern_PtmKeyAPI_GetPtmKeyUpdateBlock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PtmKeyAPI_GetPtmKeyUpdateBlock_0(rctx, inboundMarshaler, client, req, pathParams)
	...
	mux.Handle("POST", pattern_PtmKeyAPI_GetPtmKeyDeleteBlock_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PtmKeyAPI_GetPtmKeyDeleteBlock_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PtmKeyAPI_GetPtmKeyByAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PtmKeyAPI_GetPtmKeyByAccount_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_PtmKeyAPI_GetPtmKeyByAccountAndBtype_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PtmKeyAPI_GetPtmKeyByAccountAndBtype_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_PtmKeyAPI_GetPtmKeyUpdateBlock_0 = runtime.ForwardResponseMessage

	forward_PtmKeyAPI_GetPtmKeyDeleteBlock_0 = runtime.ForwardResponseMessage

	forward_PtmKeyAPI_GetPtmKeyByAccount_0 = runtime.ForwardResponseMessage

	forward_PtmKeyAPI_GetPtmKeyByAccountAndBtype_0 = runtime.ForwardResponseMessage
)
