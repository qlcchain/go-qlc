...
func addDSCreateResponseCmdByShell(parentCmd *ishell.Cmd) {
	...
	cmd := &ishell.Cmd{
		...
		Func: func(c *ishell.Context) {
			...
			if err := DSCreateResponse(addressP, hashP, actionP, privateFromP, privateForP); err != nil {
				util.Warn(err)
				return
			}
		},
...
func DSCreateResponse(addressP, hashP, actionP, privateFromP, privateForP string) error {
