...
func main() {
	...
	err = ledger.AddFrontier(fr, nil)
	if err != nil {
		fmt.Println(err)
	}
	err = ledger.AddBlock(blk1, nil)
	if err != nil {
		fmt.Println(err)
	}
	frs := &types.Frontier{
	...
	err = ledger.DeleteFrontier(fr.HeaderBlock, nil)
	if err != nil {
		fmt.Println(err)
	}
	err = ledger.AddFrontier(frs, nil)
	if err != nil {
		fmt.Println(err)
	}
	err = ledger.AddBlock(blk2, nil)
	if err != nil {
		fmt.Println(err)
	}
	frs2 := &types.Frontier{
	...
	err = ledger.AddFrontier(frs2, nil)
	if err != nil {
		fmt.Println(err)
	}
