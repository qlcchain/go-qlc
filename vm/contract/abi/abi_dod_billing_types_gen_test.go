...
func TestMarshalUnmarshalDoDInvoice(t *testing.T) {
	v := DoDInvoice{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgDoDInvoice(b *testing.B) {
	v := DoDInvoice{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgDoDInvoice(b *testing.B) {
	v := DoDInvoice{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalDoDInvoice(b *testing.B) {
	v := DoDInvoice{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeDoDInvoice(t *testing.T) {
	v := DoDInvoice{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeDoDInvoice Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeDoDInvoice(b *testing.B) {
	v := DoDInvoice{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeDoDInvoice(b *testing.B) {
	v := DoDInvoice{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
