...
func (z *ContractParam) EncodeMsg(en *msgp.Writer) (err error) {
	...
	err = en.Append(0x85, 0xb3, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d)
	if err != nil {
		return
	}
...
func (z *ContractParam) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = append(o, 0x85, 0xb3, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d)
...
func (z *ContractParam) Msgsize() (s int) {
	...
	s += 3 + msgp.Int64Size + 2 + msgp.IntSize
	return
}
...
func (z *CreateContractParam) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "t4":
			z.EndData, err = dc.ReadInt64()
			if err != nil {
				err = msgp.WrapError(err, "EndData")
				return
			}
		default:
			err = dc.Skip()
...
func (z *CreateContractParam) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendInt64(o, z.EndData)
	return
}
...
func (z *CreateContractParam) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "t4":
			z.EndData, bts, err = msgp.ReadInt64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "EndData")
				return
			}
