...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address", Type{Kind: reflect.Array, Type: addressT, Size: 32, T: AddressTy, stringKind: "address"}},
		{"address[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 32, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 32, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
		...
		{"balance", Type{Kind: reflect.Array, Type: balanceT, T: BalanceTy, stringKind: "balance"}},
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"tokenId[]", []types.Hash{{1}}, ""},
		{"tokenId[1]", []types.Hash{{1}}, ""},
		{"tokenId[1]", [1]types.Hash{{1}}, ""},
		{"tokenId[2]", [1]types.Hash{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", [32]byte{}, ""},
		{"bytes31", [31]byte{}, ""},
		{"bytes30", [30]byte{}, ""},
		{"bytes29", [29]byte{}, ""},
